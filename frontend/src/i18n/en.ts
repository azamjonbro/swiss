const en = {
  ...
  saved: {
    ...
    lede: 'The watches you have set aside to return to. The list lives on this device — no account needed.',
    emptyTitle: 'Nothing saved yet.',
    emptyBody: 'Tap the heart on any timepiece and it will be waiting here for you.',
