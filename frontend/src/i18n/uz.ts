...
const uz: Dictionary = {
  ...
  home: {
    ...
    statementAlt: 'Past yorug‘likda suratga olingan po‘lat korpusli Saint Honoré Monceau turbiyoni',
    heroImageAlt: 'To‘q yashil fonda yashil siferblatli, po‘lat brasletli West End Watch Co. Sowar soati',
  ...
  saved: {
    eyebrow: 'Sizning tanlovingiz',
    title: 'Saqlangan soatlar',
    lede: 'Keyinroq qaytish uchun saqlab qo‘ygan soatlaringiz. Ro‘yxat shu qurilmada saqlanadi — hisob talab qilinmaydi.',
    emptyTitle: 'Hozircha hech narsa saqlanmagan.',
    emptyBody: 'Yoqqan soatdagi yurakchani bosing — u shu yerda sizni kutib turadi.',
