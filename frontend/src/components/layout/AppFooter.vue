...
// Both are static (CONTACT_PHONES / CONTACT_EMAIL in @/seo/schema.mjs) and both
// are allowed to be empty. Empty renders nothing at all — a placeholder in a
// footer is read as a real one, by visitors and by structured-data parsers.
