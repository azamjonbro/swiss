...
export const BRANDS = [
  ...
  },
  {
    ...
    description: 'A passion for design and quality watchmaking. Frederique Constant creates beautiful, high-quality mechanical timepieces with classical and refined designs at accessible prices.',
    taglineRu: 'Доступная роскошь.',
    descriptionRu: 'Страсть к дизайну и качественному часовому искусству. Frederique Constant создает красивые высококачественные механические часы с классическим и изысканным дизайном по доступным ценам.',
  ...
  },
  {
    ...
    description: 'Tissot is a pioneer of craftsmanship and innovation, offering a wide range of high-quality timepieces that blend classic watchmaking with modern technology.',
    taglineRu: 'Новаторы по традиции.',
    descriptionRu: 'Tissot является пионером в области мастерства и инноваций, предлагая широкий ассортимент высококачественных часов, сочетающих в себе классическое часовое искусство с современными технологиями.',
  ...
  },
  {
    ...
    description: 'Swiss Military Hanowa combines Swiss precision and sporty design, delivering rugged, reliable timepieces built to withstand extreme conditions and everyday adventures.',
    taglineRu: 'Всегда в цель.',
    descriptionRu: 'Swiss Military Hanowa сочетает в себе швейцарскую точность и спортивный дизайн, предлагая прочные и надежные часы, созданные для экстремальных условий и повседневных приключений.',
  ...
  },
  {
    ...
    description: 'Inspired by the vibrant energy and style of Paris, Saint Honoré timepieces represent the perfect fusion of French elegance and traditional Swiss watchmaking.',
    taglineRu: 'Парижская элегантность.',
    descriptionRu: 'Вдохновленные яркой энергией и стилем Парижа, часы Saint Honoré представляют собой идеальное сочетание французской элегантности и традиционного швейцарского часового искусства.',
  ...
  {
    name: 'Cerruti 1881',
    tagline: 'The essence of Italian fashion.',
    description: 'Cerruti 1881 brings Italian fashion heritage into the world of horology, creating stylish, sophisticated watches that embody contemporary elegance and masculine grace.',
    taglineRu: 'Сущность итальянской моды.',
    descriptionRu: 'Cerruti 1881 привносит наследие итальянской моды в мир часового искусства, создавая стильные и утонченные часы, воплощающие современную элегантность и мужскую грацию.',
  ...
  {
    name: 'Roamer',
    tagline: 'True values since 1888.',
    description: 'Roamer of Switzerland stands for high-quality Swiss watches with classic, elegant designs, remaining true to its heritage of reliable and durable timekeeping.',
    taglineRu: 'Истинные ценности с 1888 года.',
    descriptionRu: 'Roamer of Switzerland — это высококачественные швейцарские часы с классическим элегантным дизайном, сохраняющие верность своему наследию надежного и долговечного измерения времени.',
  ...
  },
  {
    ...
    tagline: 'A legendary heritage.',
    description: 'With over a century of history, West End watches are renowned for their robustness and reliability, famously distributed across the Middle East and Asia since the early 1900s.',
    taglineRu: 'Легендарное наследие.',
    descriptionRu: 'Часы West End с более чем вековой историей славятся своей прочностью и надежностью, и с начала 1900-х годов широко продаются на Ближнем Востоке и в Азии.',
  ...
  },
  {
    ...
    description: 'A global leader in watchmaking, Seiko combines cutting-edge technology with traditional craftsmanship, renowned for inventing the quartz watch and Spring Drive movement.',
    taglineRu: 'Двигаясь вперед. Трогая сердца.',
    descriptionRu: 'Мировой лидер в часовом деле, Seiko сочетает передовые технологии с традиционным мастерством, прославившись изобретением кварцевых часов и механизма Spring Drive.',
  ...
  },
  {
    ...
    description: 'Citizen is globally recognized for its eco-drive technology, powering watches using any light source, and its commitment to precise, environmentally conscious timekeeping.',
    taglineRu: 'Лучшее начинается сейчас.',
    descriptionRu: 'Citizen всемирно известна своей технологией eco-drive, питающей часы от любого источника света, а также своей приверженностью к точному и экологически чистому измерению времени.',
  ...
  },
  {
    ...
    description: 'Rado is famous for its innovative use of high-tech ceramic, creating scratch-resistant, hypoallergenic, and exceptionally comfortable watches with visionary design.',
    taglineRu: 'Мастер материалов.',
    descriptionRu: 'Rado славится своим инновационным использованием высокотехнологичной керамики, создавая устойчивые к царапинам, гипоаллергенные и исключительно удобные часы с дальновидным дизайном.',
  ...
  {
    name: 'Rolex',
    tagline: 'The Oyster, since 1905.',
    description:
      'Rolex has defined the modern wristwatch since 1905 — the Oyster case, the Perpetual rotor and the Datejust\'s date window each became an industry standard, and every watch leaving Geneva carries the Superlative Chronometer certification.',
    taglineRu: 'Oyster, с 1905 года.',
    descriptionRu:
      'С 1905 года Rolex определяет облик современных наручных часов: корпус Oyster, ротор Perpetual и окошко даты Datejust стали отраслевыми стандартами, а каждые часы из Женевы имеют сертификат Superlative Chronometer.',
    taglineUz: '1905-yildan beri Oyster.',
    descriptionUz:
      'Rolex 1905-yildan beri zamonaviy qo‘l soatining qiyofasini belgilab keladi: Oyster korpusi, Perpetual rotori va Datejust sana oynasi soatsozlik standartiga aylandi, Jenevadan chiqqan har bir soat esa Superlative Chronometer sertifikatiga ega.',
    founded: 1905,
    country: 'Switzerland',
    website: 'https://www.rolex.com',
    logo: '/uploads/images/logo_rolex.jpg',
    image: '/uploads/images/banner_rolex.jpg',
  },
  {
    name: 'Omega',
    tagline: 'Olympic timing since 1932.',
    description:
      'Omega has timed the Olympic Games since 1932 and went to the Moon on the wrist of Apollo 11. Its Co-Axial escapement and Master Chronometer certification set the house\'s benchmark for precision and magnetic resistance.',
    taglineRu: 'Отсчет Олимпиад с 1932 года.',
    descriptionRu:
      'Omega отсчитывает время Олимпийских игр с 1932 года и побывала на Луне на запястье экипажа «Аполлона-11». Спуск Co-Axial и сертификация Master Chronometer задают эталон точности и антимагнитности.',
    taglineUz: '1932-yildan beri Olimpiada vaqti.',
    descriptionUz:
      'Omega 1932-yildan beri Olimpiada o‘yinlarining vaqtini o‘lchaydi va Apollo 11 ekipaji bilan Oyga bordi. Co-Axial spuski va Master Chronometer sertifikati uyning aniqlik hamda magnitga chidamlilik mezonini belgilaydi.',
    founded: 1848,
    country: 'Switzerland',
    website: 'https://www.omegawatches.com',
    logo: '/uploads/images/logo_omega.jpg',
    image: '/uploads/images/banner_omega.jpg',
  },
  {
    name: 'Cartier',
    tagline: 'The wristwatch as a shape.',
    description:
      'A Paris jeweller since 1847, Cartier shaped the wristwatch as an object of design — the Santos, the Tank and the Ballon Bleu are drawn first as shapes and only then as watches.',
    taglineRu: 'Наручные часы как форма.',
    descriptionRu:
      'Парижский ювелирный дом с 1847 года, Cartier сделал наручные часы предметом дизайна: Santos, Tank и Ballon Bleu сначала рождаются как форма и лишь затем как часы.',
    taglineUz: 'Qo‘l soati — shakl sifatida.',
    descriptionUz:
      '1847-yildan beri Parij zargarlik uyi bo‘lgan Cartier qo‘l soatini dizayn ob’ektiga aylantirdi: Santos, Tank va Ballon Bleu avval shakl sifatida, keyin esa soat sifatida tug‘iladi.',
    founded: 1847,
    country: 'France',
    website: 'https://www.cartier.com',
    logo: '/uploads/images/logo_cartier.jpg',
    image: '/uploads/images/banner_cartier.jpg',
  },
  {
    name: 'Certina',
    tagline: 'Double-sealed since 1888.',
    description:
      'Founded in Grenchen in 1888, Certina built its name on the DS concept — a double-sealed case designed to survive shock, water and pressure without giving up everyday wearability.',
    taglineRu: 'Двойная защита с 1888 года.',
    descriptionRu:
      'Основанная в Гренхене в 1888 году, Certina прославилась концепцией DS — корпусом с двойной защитой, рассчитанным на удары, воду и давление без потери повседневного комфорта.',
    taglineUz: '1888-yildan beri qo‘sh himoya.',
    descriptionUz:
      '1888-yilda Grenchenda tashkil etilgan Certina o‘z nomini DS konsepsiyasi bilan qozondi — zarba, suv va bosimga bardosh beruvchi, ayni paytda kundalik qulaylikni yo‘qotmagan qo‘sh himoyali korpus.',
    founded: 1888,
    country: 'Switzerland',
    website: 'https://www.certina.com',
    logo: '/uploads/images/logo_certina.jpg',
    image: '/uploads/images/banner_certina.jpg',
  },
  {
    name: 'Tudor',
    tagline: 'Built for the water.',
    description:
      'Founded in 1926 to pair Rolex-grade construction with a more direct price, Tudor now builds its own manufacture movements behind the Black Bay and Pelagos dive watches.',
    taglineRu: 'Создан для воды.',
    descriptionRu:
      'Основанный в 1926 году, чтобы соединить надежность уровня Rolex с более прямой ценой, Tudor сегодня выпускает собственные мануфактурные механизмы для дайверских Black Bay и Pelagos.',
    taglineUz: 'Suv uchun yaratilgan.',
    descriptionUz:
      '1926-yilda Rolex darajasidagi mustahkamlikni yanada ochiq narx bilan birlashtirish uchun tashkil etilgan Tudor bugun Black Bay va Pelagos g‘avvos soatlari uchun o‘z manufaktura mexanizmlarini ishlab chiqaradi.',
    founded: 1926,
    country: 'Switzerland',
    website: 'https://www.tudorwatch.com',
    logo: '/uploads/images/logo_tudor.jpg',
    image: '/uploads/images/banner_tudor.jpg',
  },
  {
    name: 'Hublot',
    tagline: 'The art of fusion.',
    description:
      'Hublot opened in 1980 with a gold case on a rubber strap — a pairing nobody had tried. The Art of Fusion still drives it: ceramic, sapphire and Magic Gold set against traditional watchmaking.',
    taglineRu: 'Искусство слияния.',
    descriptionRu:
      'Hublot появился в 1980 году с золотым корпусом на каучуковом ремешке — сочетанием, которого до того не существовало. Принцип Art of Fusion живет и сейчас: керамика, сапфир и Magic Gold рядом с традиционным часовым искусством.',
    taglineUz: 'Uyg‘unlik san’ati.',
    descriptionUz:
      'Hublot 1980-yilda oltin korpusni kauchuk tasma bilan birlashtirib paydo bo‘ldi — bunday uyg‘unlikni hech kim sinab ko‘rmagandi. Art of Fusion tamoyili bugun ham davom etadi: keramika, safir va Magic Gold an’anaviy soatsozlik bilan yonma-yon.',
    founded: 1980,
    country: 'Switzerland',
    website: 'https://www.hublot.com',
    logo: '/uploads/images/logo_hublot.jpg',
    image: '/uploads/images/banner_hublot.jpg',
  },
  {
    name: 'Chopard',
    tagline: 'Jeweller and manufacture.',
    description:
      'A family house since 1860, Chopard works as both jeweller and manufacture — the free-moving diamonds of Happy Diamonds on one side, the certified L.U.C calibres on the other.',
    taglineRu: 'Ювелир и мануфактура.',
    descriptionRu:
      'Семейный дом с 1860 года, Chopard работает и как ювелир, и как мануфактура: свободно движущиеся бриллианты Happy Diamonds с одной стороны и сертифицированные калибры L.U.C с другой.',
    taglineUz: 'Zargar va manufaktura.',
    descriptionUz:
      '1860-yildan beri oilaviy uy bo‘lgan Chopard ham zargar, ham manufaktura sifatida ishlaydi: bir tomonda Happy Diamonds’ning erkin harakatlanuvchi olmoslari, ikkinchi tomonda sertifikatlangan L.U.C kalibrlari.',
    founded: 1860,
    country: 'Switzerland',
    website: 'https://www.chopard.com',
    logo: '/uploads/images/logo_chopard.jpg',
    image: '/uploads/images/banner_chopard.jpg',
  },
  {
    name: 'Audemars Piguet',
    tagline: 'Steel made precious.',
    description:
      'Still run by its founding families in Le Brassus since 1875. The 1972 Royal Oak made steel a luxury material and its octagonal bezel one of watchmaking\'s most recognised shapes.',
    taglineRu: 'Сталь, ставшая драгоценной.',
    descriptionRu:
      'С 1875 года домом в Ле-Брассю по-прежнему управляют семьи основателей. Royal Oak 1972 года сделал сталь роскошным материалом, а его восьмиугольный безель — одной из самых узнаваемых форм в часовом деле.',
    taglineUz: 'Qimmatbaho po‘lat.',
    descriptionUz:
      '1875-yildan beri Le Brassus’dagi uyni hamon asoschi oilalar boshqaradi. 1972-yilgi Royal Oak po‘latni hashamat materialiga, sakkiz qirrali bezelini esa soatsozlikning eng tanilgan shakllaridan biriga aylantirdi.',
    founded: 1875,
    country: 'Switzerland',
    website: 'https://www.audemarspiguet.com',
    logo: '/uploads/images/logo_audemars_piguet.jpg',
    image: '/uploads/images/banner_audemars_piguet.jpg',
  },
  {
    name: 'Breitling',
    tagline: 'Instruments for aviation.',
    description:
      'Breitling has built instruments for aviation since 1884. The Navitimer\'s circular slide rule let pilots compute fuel burn and climb rates on the wrist, and it remains in production largely unchanged.',
    taglineRu: 'Приборы для авиации.',
    descriptionRu:
      'С 1884 года Breitling создает приборы для авиации. Круговая логарифмическая линейка Navitimer позволяла пилотам считать расход топлива и скорость набора высоты прямо на запястье — и выпускается почти без изменений до сих пор.',
    taglineUz: 'Aviatsiya uchun asboblar.',
    descriptionUz:
      'Breitling 1884-yildan beri aviatsiya uchun asboblar yaratadi. Navitimer’ning aylanma hisoblagichi uchuvchilarga yoqilg‘i sarfi va ko‘tarilish tezligini bevosita bilakda hisoblash imkonini bergan va deyarli o‘zgarmagan holda bugun ham ishlab chiqariladi.',
    founded: 1884,
    country: 'Switzerland',
    website: 'https://www.breitling.com',
    logo: '/uploads/images/logo_breitling.jpg',
    image: '/uploads/images/banner_breitling.jpg',
  },
  {
    name: 'Hamilton',
    tagline: 'American spirit, Swiss precision.',
    description:
      'Founded in Lancaster, Pennsylvania in 1892 and Swiss-made since 1974. Hamilton supplied American railroads and the military, and the 1957 Ventura was the world\'s first electric watch.',
    taglineRu: 'Американский дух, швейцарская точность.',
    descriptionRu:
      'Основана в Ланкастере, Пенсильвания, в 1892 году; с 1974 года производится в Швейцарии. Hamilton снабжала американские железные дороги и армию, а Ventura 1957 года стала первыми в мире электрическими часами.',
    taglineUz: 'Amerika ruhi, Shveytsariya aniqligi.',
    descriptionUz:
      '1892-yilda Pensilvaniya shtatining Lankaster shahrida tashkil etilgan, 1974-yildan beri Shveytsariyada ishlab chiqariladi. Hamilton Amerika temir yo‘llari va armiyasini ta’minlagan, 1957-yilgi Ventura esa dunyodagi birinchi elektr soat bo‘lgan.',
    founded: 1892,
    country: 'Switzerland',
    website: 'https://www.hamiltonwatch.com',
    logo: '/uploads/images/logo_hamilton.jpg',
    image: '/uploads/images/banner_hamilton.jpg',
  },
  {
    name: 'Bvlgari',
    tagline: 'Roman design, thinnest calibres.',
    description:
      'A Roman jeweller since 1884, Bvlgari brought its own vocabulary to watchmaking — and with the Octo Finissimo took the record for the world\'s thinnest watches, repeatedly.',
    taglineRu: 'Римский дизайн, тончайшие калибры.',
    descriptionRu:
      'Римский ювелирный дом с 1884 года, Bvlgari принес в часовое дело собственный язык форм — а с Octo Finissimo неоднократно устанавливал рекорды самых тонких часов в мире.',
    taglineUz: 'Rim dizayni, eng yupqa kalibrlar.',
    descriptionUz:
      '1884-yildan beri Rim zargarlik uyi bo‘lgan Bvlgari soatsozlikka o‘z shakl tilini olib kirdi va Octo Finissimo bilan dunyodagi eng yupqa soat rekordini bir necha bor yangiladi.',
    founded: 1884,
    country: 'Italy',
    website: 'https://www.bulgari.com',
    logo: '/uploads/images/logo_bvlgari.jpg',
    image: '/uploads/images/banner_bvlgari.jpg',
  },
  {
    name: 'Swatch',
    tagline: 'The watch that saved Swiss watchmaking.',
    description:
      'Swatch answered the quartz crisis in 1983 with a Swiss watch of 51 parts in a sealed plastic case — cheap, accurate and deliberately disposable in spirit, and it saved the industry it was born into.',
    taglineRu: 'Часы, спасшие швейцарское часовое дело.',
    descriptionRu:
      'В 1983 году Swatch ответил на кварцевый кризис швейцарскими часами из 51 детали в цельном пластиковом корпусе — дешевыми, точными и подчеркнуто несерьезными, и тем самым спас отрасль, в которой родился.',
    taglineUz: 'Shveytsariya soatsozligini qutqargan soat.',
    descriptionUz:
      'Swatch 1983-yilda kvars inqiroziga 51 ta detaldan iborat, yopiq plastik korpusli Shveytsariya soati bilan javob berdi — arzon, aniq va ataylab yengil ruhdagi bu soat o‘zi tug‘ilgan sohani qutqardi.',
    founded: 1983,
    country: 'Switzerland',
    website: 'https://www.swatch.com',
    logo: '/uploads/images/logo_swatch.jpg',
    image: '/uploads/images/banner_swatch.jpg',
  },
  {
    name: 'Emporio Armani',
    tagline: 'Design first.',
    description:
      'The Emporio Armani line carries Giorgio Armani\'s design language onto the wrist — restrained proportions and a muted palette, built as fashion watches rather than complications.',
    taglineRu: 'Дизайн прежде всего.',
    descriptionRu:
      'Линия Emporio Armani переносит язык дизайна Джорджо Армани на запястье: сдержанные пропорции и приглушенная палитра, сделанные как модные часы, а не как усложнения.',
    taglineUz: 'Avvalo dizayn.',
    descriptionUz:
      'Emporio Armani liniyasi Jorjio Armanining dizayn tilini bilakka olib chiqadi — vazmin nisbatlar va bosiq rang palitrasi, murakkab mexanizm emas, moda soati sifatida yaratilgan.',
    founded: 1981,
    country: 'Italy',
    website: 'https://www.armani.com',
    logo: '/uploads/images/logo_emporio_armani.jpg',
    image: '/uploads/images/banner_emporio_armani.jpg',
  }
];
